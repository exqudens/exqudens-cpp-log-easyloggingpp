...
function(vscode)
    ...
    if(NOT "${${currentFunctionName}_LAUNCH_FILE}" STREQUAL "")
        ...
        string(JSON entry SET "${entry}" "console" "\"internalConsole\"")
        ...
        string(JSON entry SET "${entry}" "environment" "1" "{}")
        string(JSON entry SET "${entry}" "environment" "1" "name" "\"PROJECT_BINARY_DIR\"")
        string(JSON entry SET "${entry}" "environment" "1" "value" "\"${PROJECT_BINARY_DIR}\"")
